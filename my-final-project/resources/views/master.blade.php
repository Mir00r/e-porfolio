            ...
            <div class="navbar-custom-menu">
              ...
              <nav class = "collapse navbar-collapse" role = "navigation">
                ...
                <div class="container-1">
                    ...
                    {!! Form::open([ 'url' => 'user/search', 'method' => 'GET']) !!}
                ...
                <ul class="nav navbar-nav" style="padding-right: 10px">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="{{ url('/profile_page/index') }}" class="dropdown-toggle" data-toggle="dropdown">
                            <?php $user=Auth::user(); ?>
                            <img src=" {{ asset('profile/dist/img/'.$user->avatar)  }}" class="user-image" alt="User Image">
        ...
        <section class="sidebar"  >
          ...
          <div class="user-panel" style="background-color: #DCDEE3">
            <div class="pull-left image"  >
               <?php $user=Auth::user(); ?>
              <img src="{{ asset('profile/dist/img/'.$user->avatar)  }}" class="img-rounded" alt="User Image">
            </div>
          ...
          <ul class="sidebar-menu" >
            ...
            <li class="header" style="background-color: #DCDEE3"></li>
            <li  >
              <a href="{{url('aboutme')}}" style="color: black " >
            ...
            <li class="treeview">
              <a href="{{ url('/form/add-coding') }}" target="_blank">
            ...
            <ul>
              <li><a href=" {{ url('/auth/facebook')  }} "><i id="sociel-icon" class="fa fa-facebook-square fa-3x fb"></i></a></li>
            ...
            <div class="content">
              <div class="row" > 
                <div class="col-lg-2 ">
                  ...
                  <a href="">
                    <?php $user=Auth::user(); ?>
                    <img height="160" width="160" src=" {{ asset('profile/dist/img/'.$user->avatar)  }}">
                  </a>

                  <br><br>
                    
                    {!! Form::open(['url'=>'user/store','files'=>true]) !!}
...
{{--                    <input type="hidden" name="user_id" value="{{ $user_id }}">--}}
                ...
                <div class="col-lg-3 col-xs-6" id="pro-info">
                    ...
                    <div class="inner">
                      ...
                      <p><span style="color:green">Studying In-</span>{{$list->university}}</p>
                      <p><span style="color:green">Lives In-</span>{{$list->lives}}</p>
                      <p><span style="color:green">Interested In-</span>{{$list->interested}}</p>
                      @endforeach
                    @endif
                    </div>
                    {{--@endforeach--}}
                   ...
                   <a href="{{url('editprofile')}}" class="btn btn-info">Edit Profile</a>
                   {{--@endif--}}
              </div>
