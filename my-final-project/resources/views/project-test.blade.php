        ...
        <div class="container">
            <div class="head-sec">
               ...
               <div class="form-title-text">
                ...
                <a href="{{ url('/form/add-project') }}">
                    <button class="btn btn-lg btn-info button">+ Add New Project </button>
                </a>
        </div>
        <hr class="hr">
<style type="text/css">
 ...
 .button2{
    ...
    <div class="viewpage">
        ...
        <form action="">
          ...
          <a class="btn btn-danger button2" href="{{url('/project-test?delete='.$list->id)}}">Delete</a>
          <br><hr >
        </form>
    </div>
    @endforeach
